...
let muteInfoContainer = document.querySelector("#mute-info-container");
...
export default class Game {
  ...
  increaseVelocity() {
    ...
    wohoSound.play();
    this.gameView.increaseVelocities([
      this.gameView.rocks,
      this.gameView.catchables,
      this.gameView.rivers,
    ]);
  }

  decreaseVelocity() {
    this.gameView.decreaseVelocities([
      this.gameView.rocks,
      this.gameView.catchables,
      this.gameView.rivers,
    ]);
